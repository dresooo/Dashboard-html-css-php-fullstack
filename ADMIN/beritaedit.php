...
<?php include "INCLUDE/head.php"; ?>
                ...
                <main>
                    ...
                    <?php
                        ...
                        if(isset($_POST['edit']))
                        {
                            ...
                            mysqli_query($connection, "update berita set beritaDRESO='$beritaDRESO', kategoriberita825220026='$kategoriberita825220026', event825220026='$event825220026', namarestoran='$namarestoran' where berita825220026='$berita825220026' ");
                        
                        }
                        // select from diffrent table
                        $namarestoran = mysqli_query($connection,"select * from restoran");

                        $berita825220026 = $_GET['ubah'];
                        $editberita = mysqli_query($connection,"select * from berita where berita825220026 = '$berita825220026'");
                        $rowedit = mysqli_fetch_array($editberita);
                        $namarestoranResult = mysqli_query($connection,"select * from restoran");
                        $rowNamarestoran = mysqli_fetch_array($namarestoranResult);
                    ?>
        ...
        <div class="col-sm-10">
            <form method="POST">
                <div class="mb-3 row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodeberita" id="kodeberita" maxlenght="4" value="<?php echo $rowedit["berita825220026"] ?>" readonly >
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="namaberita" class="col-sm-2 col-form-label">Nama Berita</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="namaberita" id="namaberita" value="<?php echo $rowedit["beritaDRESO"] ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="kategoriberita" class="col-sm-2 col-form-label">Kategori Berita</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kategoriberita" id="kategoriberita" value="<?php echo $rowedit["kategoriberita825220026"] ?>">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="eventberita" class="col-sm-2 col-form-label">Event Berita</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="eventberita" id="eventberita" value="<?php echo $rowedit["event825220026"] ?>">
                    </div>
                </div>           
    ...
    <div class="col-sm-10">
    <input type="text" class="form-control" name="namarestoran" id="namarestoran" value="<?php echo $rowedit["namarestoran"] ?>">
    </div>
</div>    
