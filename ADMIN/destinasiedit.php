        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                if (isset($_POST['edit'])) {
                    ...
                    mysqli_query($connection, "update destinasi set destinasiNAMA='$destinasiNAMA', destinasiKET='$destinasiKET', kategoriKODE='$kategoriKODE', destinasiFOTO='$destinasiFOTO' where destinasiKODE='$destinasiKODE' ");
                        ...
                        <div class="col-sm-10">
                            <form method="POST" enctype="multipart/form-data">
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control" name="kodedestinasi" id="kodedestinasi" maxlength="4" value="<?php echo $rowedit["destinasiKODE"] ?>" readonly>
                                    </div>
                                </div>
                                <div class="mb-3 row">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-10">
                                    <input type="text" class="form-control" name="kodekategori" id="kodekategori" value="<?php echo $rowedit["kategoriKODE"] ?>" >
                                    </div>
                                </div>
