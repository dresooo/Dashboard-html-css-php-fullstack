...
//		$kodedestinasi = $_POST['kodedestinasi'];
		...
		if(($ekstensifile == "jpg") or ($ekstensifile == "JPG"))
		{
			...
			mysqli_query($connection, "insert into hotel value ('$hotelKODE', '$hotelNAMA', '$hotelKET', '$hotelFILE')");
...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namarestoran" name="inputkode" placeholder="Kode Hotel" >
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="menurestoran" name="inputnama" placeholder="Nama Hotel">
			</div>
		</div>
    ...
    <div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namafoto" name="keterangan" placeholder="Keterangan Hotel">
			</div>
		</div>
		 ...
		 <!-- untuk search data -->
 						<?php
								...
								//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
										...
										{
											$query = mysqli_query($connection, "select hotel.* 
												from hotel limit $mulaitampilan, $jumlahtampilan");
										}
								//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
