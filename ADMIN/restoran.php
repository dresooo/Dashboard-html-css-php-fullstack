...
<div class="col-sm-10">
	...
	<form method="POST" enctype="multipart/form-data">
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namarestoran" name="inputkode" placeholder="Nama Restoran" >
			</div>
		</div>
		...
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="menurestoran" name="inputnama" placeholder="Menu Restoran">
			</div>
		</div>
    ...
    <div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="text" class="form-control" id="namafoto" name="keterangan" placeholder="Keterangan Restoran">
			</div>
		</div>
		 ...
		 <!-- untuk search data -->
 						<?php
									...
									//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
										...
										{
											$query = mysqli_query($connection, "select restoran.* 
												from restoran limit $mulaitampilan, $jumlahtampilan");
										}
									//	pada bagian ini tambhan --- limit $mulaitampilan, $jumlahtampilan ---	
