...
<?php include "INCLUDE/head.php"; ?>
                ...
                <main>
                    ...
                    <?php
                        ...
                        if(isset($_POST['Simpan']))
                        {
                            ...
                            $olehNAMA = $_POST["namarestoran"];
                            // $olehKODE = $_POST["namarestoran"];
                            
                            mysqli_query($connection, "insert into travel values ('$travelKODE', '$travelNAMA', '$travelKET','$olehNAMA')");
                            header("location:travel.php");
                        }
                        // select from diffrent table
                        $olehKODE = mysqli_query($connection,"select * from oleh");
                        $olehNAMA = mysqli_query($connection,"select * from oleh");
    ...
    <div class="col-sm-1">
        ...
        <div class="col-sm-10">
            <form method="POST">
                <div class="mb-3 row">
                    <label for="kodeberita" class="col-sm-2 col-form-label">Kode Travel</label>   
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="kodeberita" id="kodeberita" maxlenght="4" >
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="namaberita" class="col-sm-2 col-form-label">Nama Travel</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="namaberita" id="namaberita">
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="kategoriberita" class="col-sm-2 col-form-label">Kategori Travel</label>
                    <div class="col-sm-10">
    ...
    <?php while ($row = mysqli_fetch_array($olehNAMA)) { ?>
        <option value="<?php echo $row["olehNAMA"] ?>">
                ...
                <?php
                        ...
                        if(isset($_POST["kirim"]))
                        {
                            ...
                            $query = mysqli_query($connection, "select travel.* 
                                from travel
                                where travelNAMA like '%".$search."%' limit $mulaitampilan, $jumlahtampilan");
                        // --------------------- PAGING -- MEMBUAT GANTI HALAMAN ---------------- 
